...
def run():
    ...
    for s in sets:
        cmd = "python eval/save_results.py --experiment ycb/experiments/%s --weightfile run/%s/set_%s_000/model_best.pth.tar --modelcfg cfg/yolo-pose.cfg"%(s, s, s)
