...
def run():
    ...
    for s in sets:
        cmd = "python train_ycb.py --experiment ycb/experiments/%s --kw t2_%s --train-fixed-size 700 --weightfile cfg/darknet19_448.conv.23 --modelcfg cfg/yolo-pose.cfg"%(s, s)
